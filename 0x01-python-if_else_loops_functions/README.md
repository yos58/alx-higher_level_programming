...
file 2. I sometimes suffer from insomnia. And when I can't fall asleep, I play what I call the alphabet game
...
file 3. When I was having that alphabet soup, I never thought that it would pay off
program that prints the ASCII alphabet, in lowercase, not followed by a new line.
...
file 6. Inventing is a combination of brains and materials. The more brains you use, the less material you need
...
file 9. There are only 3 colors, 10 digits, and 7 notes; it's what we do with them that's important
...
file 13. Insert in sorted linked list
